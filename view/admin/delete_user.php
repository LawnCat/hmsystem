...
<head>
    ...
    <link rel="stylesheet" href="../../css/admin/delete_user.css">
...
<body>
    ...
    <div class="body">
        ...
        <div class="func">
            ...
            <form action="../../controllers/admin/user_delete.php" method="post" class='add_ticket_form'>
                <div class="account">
                    <input name="id" class="account_input" type="text" value="" placeholder="     请输入ID">
                </div>
